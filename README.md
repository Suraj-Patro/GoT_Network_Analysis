...
```python
# loading datasets
!wget -qnc -P datasets https://raw.githubusercontent.com/Suraj-Patro/GoT_Network_Analysis/main/datasets/book1.csv
!wget -qnc -P datasets https://raw.githubusercontent.com/Suraj-Patro/GoT_Network_Analysis/main/datasets/book2.csv
!wget -qnc -P datasets https://raw.githubusercontent.com/Suraj-Patro/GoT_Network_Analysis/main/datasets/book3.csv
!wget -qnc -P datasets https://raw.githubusercontent.com/Suraj-Patro/GoT_Network_Analysis/main/datasets/book4.csv
!wget -qnc -P datasets https://raw.githubusercontent.com/Suraj-Patro/GoT_Network_Analysis/main/datasets/book5.csv
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fa92eb38150>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fa92ea21710>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fa92e579f50>
